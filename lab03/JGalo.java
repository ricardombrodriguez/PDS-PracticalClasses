...
public class JGalo extends JFrame implements ActionListener {
	...
	public static void main(String args[]) {
		if (args.length == 0) {																						//sem passagem de arg.
			new JGalo( new Actions() );
		} else if (args.length == 1 && (args[0].toUpperCase().equals("X") || args[0].toUpperCase().equals("O"))) {	//passagem de arg.
			new JGalo( new Actions(args[0].toUpperCase().charAt(0)) );
		} else {																									//arg. inválido
